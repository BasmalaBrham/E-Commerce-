        ...
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset($category->image)}}"  width="124"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide product-card product-card_style3">
                        ...
                        <a href="{{route('shop.product.details',$sproduct->slug)}}">
                            <img loading="lazy" src="{{asset($sproduct->image)}}"  width="258" height="313"
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                ...
                <div class="pc__img-wrapper">
                    ...
                    <img loading="lazy" src="{{asset($fproduct->image)}}"  width="330" height="400"
