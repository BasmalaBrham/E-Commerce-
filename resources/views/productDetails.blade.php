        ...
        <div class="col-lg-7">
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset($product->image)}}" width="674" height="674" alt="{{$product->name}}" />
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset($product->image)}}" width="104" height="104" alt="" /></div>
                  @foreach (explode(',', $product->images) as $gimg )
                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="{{asset($gimg)}}" width="104" height="104" alt="" />
                    </div>
                    @endforeach
                </div>
              </div>
          ...
          <div class="swiper-wrapper">
            @foreach ($rproducts as $rproduct)
                ...
                <div class="pc__img-wrapper">
                    ...
                    <img loading="lazy" src="{{asset($rproduct->image)}}" width="330" height="400"
                        alt="{{$rproduct->name}}" class="pc__img">
                    @foreach (explode(',', $rproduct->images) as $rgimg )
                    <img loading="lazy" src="{{asset($rgimg)}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img pc__img-second">
                    @endforeach
                    </a>
                    <button
                ...
                <div class="pc__info position-relative">
                    ...
                    <h6 class="pc__title"><a href="{{route('shop.product.details',$product->slug)}}">{{$rproduct->name}}</a></h6>
